...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "GreenHouse.MobileApp.Android.dll" comes first in this list. */
		"GreenHouse.MobileApp.Android.dll",
		"FormsViewGroup.dll",
		"GraphQL.Client.dll",
		"GraphQL.Common.dll",
		"GreenHouse.MobileApp.dll",
		"Newtonsoft.Json.dll",
		...
		"GreenHouse.MobileApp.Core.dll",
		"GreenHouse.MobileApp.Infrastructure.dll",
	};
